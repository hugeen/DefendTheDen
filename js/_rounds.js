...
rounds[2] = function() {
    ...
    round.create(2);
    round.addWave("!!p!p!", lastWave++);
    round.addWave("!p!p!!", lastWave += 4.5);
    round.addWave("!p!p!p", lastWave += 4.5);
    round.addWave("p!!!p!", lastWave += 6);
    round.addWave("p!p!p!", lastWave += 4.5);
    round.addWave("p!!!p!", lastWave += 6);
    round.addWave("pp!!pp", lastWave += 4.5);
    round.play();
    return round;
};
rounds[3] = function() {
    ...
    round.addWave("p!!!!r", lastWave += 3.5);
    round.addWave("!p!!r!", lastWave += 3.5);
    round.addWave("!!pr!!", lastWave += 3.5);
    round.addWave("prprpr", lastWave += 3.5);
    round.play();
    return round;
};
rounds[4] = function() {
...
rounds[5] = function() {
    ...
    round.addWave("!!!!r!", lastWave += 1.5);
    round.addWave("!r!!!p", lastWave += 4.5);
    round.addWave("!!!r!p", lastWave += 4.5);
    round.addWave("p!!!p!", lastWave += 4.5);
    round.addWave("pppppp", lastWave += 4);
    round.addWave("prpprp", lastWave += 8);
